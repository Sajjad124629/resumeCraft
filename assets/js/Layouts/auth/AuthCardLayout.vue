<template>
    <div>
        <div class="absolute inset-0">
            <img src="/dashboard-asset/assets/images/auth/bg-gradient.png" alt="image"
                class="object-cover w-full h-full" />
        </div>

        <div
            class="relative flex min-h-screen items-center justify-center bg-[url(/dashboard-asset/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
            <img src="/dashboard-asset/assets/images/auth/coming-soon-object1.png" alt="image"
                class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
            <img src="/dashboard-asset/assets/images/auth/coming-soon-object2.png" alt="image"
                class="absolute left-24 top-0 h-40 md:left-[30%]" />
            <img src="/dashboard-asset/assets/images/auth/coming-soon-object3.png" alt="image"
                class="absolute right-0 top-0 h-[300px]" />
            <img src="/dashboard-asset/assets/images/auth/polygon-object.svg" alt="image"
            ...
            <div
                ...
                <div
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10" v-if="route().current('login')">
                        ...
                        <div class="mb-10" v-else>
                            ...
                            <p class="text-base font-bold leading-normal text-white-dark">Enter your information to
                                register</p>
                        </div>
                        <slot />
                    </div>
