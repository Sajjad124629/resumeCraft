            ...
            <div
                ...
                <div
                    ...
                    <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                        <TextLink :href="route('dashboard')" class="w-48 block lg:w-72 ms-10 flex items-center">
                            <img :src="settings.logo ? '/storage/' + settings.logo : '/assets/images/logo.svg'" :alt="settings.title" class="w-[100px]" />
                ...
                <div
                    ...
                    <div
                        ...
                        <TextLink :href="route('dashboard')" class="w-8 block lg:hidden">
