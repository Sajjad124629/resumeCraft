...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="width" :height="height" viewBox="0 0 24 24" fill="none" class="injected-svg"
        data-src="https://cdn.hugeicons.com/icons/contact-stroke-rounded.svg?v=3.0"
        ...
        <path d="M8 4V2" :stroke="color" stroke-width="1.5" stroke-linecap="round"></path>
        <path d="M16 4V2" :stroke="color" stroke-width="1.5" stroke-linecap="round"></path>
        <path
