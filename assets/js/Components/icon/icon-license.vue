<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="injected-svg"
        data-src="https://cdn.hugeicons.com/icons/license-draft-stroke-rounded.svg?v=2.0"
        ...
        <path d="M7.25024 7H15.2502M7.25024 12H15.2502" stroke="#9b9b9b" stroke-width="1.5" stroke-linecap="round">
        </path>
        <path
            ...
            stroke="#9b9b9b" stroke-width="1.5" stroke-linejoin="round"></path>
    </svg>
</template>
