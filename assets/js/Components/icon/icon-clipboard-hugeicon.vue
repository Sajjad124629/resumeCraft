...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="width" :height="height" viewBox="0 0 24 24" fill="none" class="injected-svg"
        data-src="https://cdn.hugeicons.com/icons/task-01-stroke-rounded.svg?v=2.0"
        ...
        <path d="M7.99609 15.0003H11.4247M7.99609 11.0003H15.9961" :stroke="color" stroke-width="1.5"
