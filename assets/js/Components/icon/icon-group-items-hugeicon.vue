...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" :width="width" :height="height" viewBox="0 0 24 24" fill="none" class="injected-svg"
        data-src="https://cdn.hugeicons.com/icons/group-items-stroke-rounded.svg?v=3.0"
        ...
        <path
            ...
            :stroke="color" stroke-width="1.5"></path>
        <path d="M20 6V18M18 20H6M18 4H6M4 6V18" :stroke="color" stroke-width="1.5" stroke-linecap="round"
