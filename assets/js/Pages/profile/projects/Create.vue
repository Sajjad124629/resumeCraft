...
const submit = () => {
    form.post(route('app_profile_project_create'));
};
</script>

<template>

    <Head :title="__('Create Project')" />
    ...
    <div>
        <div class="panel pb-3 mt-6 bg-white dark:bg-gray-800 rounded shadow p-5">
            <div class="mb-8 border-b ml-[-1.3rem] mr-[-1.3rem] border-gray-200 dark:border-gray-700">
                <div class="ml-5 mb-4">
                    <h5 class="font-semibold text-lg">{{ __('Create Project') }}</h5>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="flex justify-end items-center mt-8 mb-4">
                    ...
                    <Button type="submit" :disabled="form.processing"
                        ...
                        {{ form.processing ? __('Creating...') : __('Create Project') }}
                    </Button>
                </div>
            </form>
        </div>
